...
(function() {
    ...
    const NAV_ITEMS = [
        ...
        { title: 'Guest Directory', url: '/app/intelligence/guests/', icon: 'fa-address-book', section: 'Intelligence' },
        { title: 'Network Analysis', url: '/app/intelligence/network/', icon: 'fa-diagram-project', section: 'Intelligence' },
        { title: 'Social Metrics', url: '/app/intelligence/social/', icon: 'fa-chart-simple', section: 'Intelligence' },
